            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if (Auth()->user() && Auth()->user()->usertype == 'user')
                        ...
                        <x-nav-link :href="route('borrow.history')" :active="request()->routeIs('borrow.history')">
                            {{ __('ประวัติการยืมคืน') }}
                        </x-nav-link>
                    @endif
                    ...
                    @if (Auth()->user() && Auth()->user()->usertype == 'admin')
                        ...
                        <x-nav-link :href="route('admin.user.logs')" :active="request()->routeIs('admin.user.logs')">
                            {{ __('Log') }}
                        </x-nav-link>
                    @endif
                    @if (Auth()->user() && Auth()->user()->usertype == 'librarian')
                        ...
                        <x-nav-link :href="route('librarian.borrow.history')" :active="request()->routeIs('librarian.borrow.history')">
                            {{ __('ประวัติการยืมคืน') }}
                        </x-nav-link>
                    @endif
